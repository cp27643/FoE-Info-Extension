  ...
  k(
    ...
    function (b, a) {
      ...
      b.Chart.prototype.getDataRows = function (a) {
        var c = this.hasParallelCoordinates,
          ...
          C = function (h, c, d) {
            ...
            return (
              h ?
                h instanceof b.Axis ?
                  (h.options.title && h.options.title.text) ||
                  (h.isDatetimeAxis ? 'DateTime' : 'Category')
                : a ?
                  {
        ...
        this.series.forEach(function (h) {
          var t = h.options.keys || h.pointArrayMap || ['y'],
            ...
            n;
          if (
            !1 !== h.options.includeInDataExport &&
            !h.options.isInternal &&
            !1 !== h.visible
          ) {
            b.find(g, function (a) {
              return a[0] === k;
            ...
            for (n = 0; n < q; )
              (r = C(h, t[n], t.length)),
                w.push(r.columnTitle || r),
                a && B.push(r.topLevelColumnTitle || r),
                n++;
            var x = {
              chart: h.chart,
            ...
            h.options.data.forEach(function (a, b) {
              ...
              for (p[a].xValues[k] = g.x; n < q; )
                (b = t[n]),
                  ...
                  (p[a][y + n] = v(
                    f.categoryMap[b][m],
                    f.dateTimeValueAxisMap[b] ?
                      d.dateFormat(e.dateFormat, m)
                    : null,
                    m,
                  )),
                  n++;
          ...
          f.forEach(function (a) {
            ...
            x &&
              ...
              (x.isDatetimeAxis ?
                ...
                (b = d.dateFormat(e.dateFormat, a.x)))
              : (b =
                  x.categories ?
                    v(x.names[a.x], x.categories[a.x], a.x)
                  : a.x));
            a.splice(l, 0, b);
          });
        }
      ...
      b.Chart.prototype.viewData = function () {
        this.dataTableDiv ||
          ((this.dataTableDiv = A.createElement('div')),
