...
(function (e) {
        ...
        g.prototype.open = function () {
          ...
          if (h.browserProps) {
            ...
            if (g.container.parentNode instanceof Element) {
              var e =
                g.container.parentNode[h.browserProps.requestFullscreen]();
              if (e)
                e['catch'](function () {
        ...
        g.prototype.setButtonText = function () {
          var h,
            ...
            n =
              (
                null ===
                  (h = null === e || void 0 === e ? void 0 : e.buttons) ||
                void 0 === h
              ) ?
                void 0
          ...
          (null === e || void 0 === e ? 0 : e.menuItemDefinitions) &&
            ...
            f &&
            f.length &&
            (f[n.indexOf('viewFullscreen')].innerHTML =
              this.isOpen ?
                h.exitFullscreen
              : e.menuItemDefinitions.viewFullscreen.text || h.viewFullscreen);
        };
  ...
  m(
    ...
    function (f, g, e) {
      ...
      x(C.prototype, {
        ...
        contextMenu: function (a, b, c, d, e, f, r) {
          ...
          if (!l) {
            ...
            b.forEach(function (a) {
              'string' === typeof a &&
                (a = k.options.exporting.menuItemDefinitions[a]);
              if (J(a, !0)) {
        ...
        addButton: function (a) {
          ...
          if (!1 !== d.enabled) {
            ...
            : d.text || x(k, { width: d.width, height: d.height, padding: 0 });
            b.styledMode ||
            ...
            if (d.symbol) {
              var l = c
                .symbol(d.symbol, d.symbolX - f / 2, d.symbolY - f / 2, f, f, {
                  width: f,
                  height: f,
                })
      ...
      F.prototype.inlineToAttributes =
