...
(function (e) {
  ...
  : 'function' === typeof define && define.amd ?
    define('highcharts/modules/annotations', ['highcharts'], function (m) {
      e(m);
      e.Highcharts = m;
      return e;
    })
  ...
  function m(d, c, e, k) {
    d.hasOwnProperty(c) || (d[c] = k.apply(null, e));
  }
  e = e ? e._modules : {};
  m(
    e,
    'annotations/eventEmitterMixin.js',
    ...
    function (d, c) {
      ...
      return {
        addEvents: function () {
          var a = this;
          e(a.graphic.element, 'mousedown', function (h) {
            a.onMouseDown(h);
          });
          b(a.options.events, function (h, b) {
            var f = function (g) {
              ('click' === b && a.cancelClick) ||
                h.call(a, a.chart.pointer.normalize(g), a.target);
            };
            if (-1 === k(b, a.nonDOMEvents || [])) a.graphic.on(b, f);
            else e(a, b, f);
          });
          a.options.draggable &&
            (e(a, 'drag', a.onDrag),
            a.graphic.renderer.styledMode ||
              a.graphic.css({
                cursor: { x: 'ew-resize', y: 'ns-resize', xy: 'move' }[
                  a.options.draggable
                ],
              }));
          a.isUpdating || v(a, 'add');
        },
        ...
        onMouseDown: function (a) {
          ...
          if (2 !== a.button) {
            ...
            h.removeDrag = e(d.doc, 'mousemove', function (a) {
              h.hasDragged = !0;
              a = b.normalize(a);
              a.prevChartX = f;
              a.prevChartY = g;
            ...
            h.removeMouseUp = e(d.doc, 'mouseup', function (g) {
              h.cancelClick = h.hasDragged;
              h.hasDragged = !1;
              h.chart.hasDraggedAnnotation = !1;
              v(t(h.target, h), 'afterUpdate');
              h.onMouseUp(g);
            });
          }
        },
        ...
        onDrag: function (a) {
          if (
            ...
            var h = this.mouseMoveToTranslation(a);
            'x' === this.options.draggable && (h.y = 0);
            'y' === this.options.draggable && (h.x = 0);
            this.points.length ?
              this.translate(h.x, h.y)
            : (this.shapes.forEach(function (a) {
                a.translate(h.x, h.y);
              }),
        ...
        mouseMoveToRadians: function (a, h, b) {
          var f = a.prevChartY - b,
            g = a.prevChartX - h;
          b = a.chartY - b;
          a = a.chartX - h;
          this.chart.inverted &&
            ((h = g), (g = f), (f = h), (h = a), (a = b), (b = h));
          return Math.atan2(b, a) - Math.atan2(f, g);
        },
        mouseMoveToTranslation: function (a) {
          var h = a.chartX - a.prevChartX;
        ...
        mouseMoveToScale: function (a, h, b) {
          h = (a.chartX - h || 1) / (a.prevChartX - h || 1);
          a = (a.chartY - b || 1) / (a.prevChartY - b || 1);
          this.chart.inverted && ((b = a), (a = h), (h = b));
          return { x: h, y: a };
        },
        destroy: function () {
          this.removeDocEvents();
  ...
  m(
    e,
    'annotations/ControlPoint.js',
    [e['parts/Utilities.js'], e['annotations/eventEmitterMixin.js']],
    function (d, c) {
      var e = d.extend,
        k = d.merge,
        b = d.pick;
      d = function (c, d, e, a) {
        ...
        this.target = d;
        this.options = e;
        this.index = b(e.index, a);
      };
      e(d.prototype, c);
      d.prototype.nonDOMEvents = ['drag'];
      ...
      d.prototype.render = function () {
        var b = this.chart,
          c = this.options;
        this.graphic = b.renderer
          .symbol(c.symbol, 0, 0, c.width, c.height)
          .add(b.controlPointsGroup)
          .css(c.style);
      ...
      d.prototype.update = function (b) {
        var c = this.chart,
          d = this.target,
          a = this.index;
        b = k(!0, this.options, b);
        this.destroy();
        this.constructor(c, d, b, a);
    ...
    function (d, c) {
      ...
      var k = function (b, c, e) {
        this.series = {
          visible: !0,
          chart: b,
          getPlotBox: d.Series.prototype.getPlotBox,
        };
        this.target = c || null;
        this.options = e;
        this.applyOptions(this.getOptions());
      };
      k.fromPoint = function (b) {
        return new k(b.series.chart, null, {
          x: b.x,
          y: b.y,
      ...
      k.pointToPixels = function (b, c) {
        ...
        e.inverted &&
          (b.mock ?
            ((a = b.plotY), (h = b.plotX))
          : ((a = e.plotWidth - b.plotY), (h = e.plotHeight - b.plotX)));
        d &&
          !c &&
          ((b = d.getPlotBox()), (a += b.translateX), (h += b.translateY));
        return { x: a, y: h };
      };
      k.pointToOptions = function (b) {
        return { x: b.x, y: b.y, xAxis: b.series.xAxis, yAxis: b.series.yAxis };
      };
      c(k.prototype, {
        mock: !0,
        ...
        setAxis: function (b, c) {
          c += 'Axis';
          b = b[c];
          var q = this.series.chart;
          this.series[c] =
            b instanceof d.Axis ? b
            : e(b) ? q[c][b] || q.get(b)
            : null;
        },
        toAnchor: function () {
        ...
        refresh: function () {
          ...
          : ((this.x = null), (this.plotX = d.x));
          b ?
            ((this.y = d.y), (this.plotY = b.toPixels(d.y, !0)))
          : ((this.y = null), (this.plotY = d.y));
          this.isInside = this.isInsidePane();
        },
        translate: function (b, c, d, e) {
          this.hasDynamicOptions() ||
            ((this.plotX += d), (this.plotY += e), this.refreshOptions());
        },
        ...
        rotate: function (b, c, d) {
          if (!this.hasDynamicOptions()) {
            ...
            a -= b;
            h -= c;
            this.plotX = a * e - h * d + b;
            this.plotY = a * d + h * e + c;
            this.refreshOptions();
          }
        },
        refreshOptions: function () {
          ...
          this.x = this.options.x =
            c ? (this.options.x = c.toValue(this.plotX, !0)) : this.plotX;
  ...
  m(
    e,
    'annotations/controllable/controllableMixin.js',
    [
      e['parts/Utilities.js'],
      e['annotations/ControlPoint.js'],
      e['annotations/MockPoint.js'],
      e['parts/Tooltip.js'],
    ],
    function (d, c, e, k) {
      var b = d.isObject,
      ...
      return {
        ...
        attrsFromOptions: function (a) {
          ...
          for (f in a) {
            var l = b[f];
            !l ||
              (g && -1 !== ['fill', 'stroke', 'stroke-width'].indexOf(l)) ||
              (c[l] = a[f]);
          }
          return c;
        },
        anchor: function (a) {
          var b = a.series.getPlotBox();
          a =
            a.mock ?
              a.toAnchor()
            : k.prototype.getAnchor.call({ chart: a.series.chart }, a);
          a = {
        ...
        point: function (a, c) {
          ...
          (c && null !== c.series) ||
            (b(a) ? (c = new e(this.chart, this, a))
            : t(a) ? (c = this.chart.get(a) || null)
            : 'function' === typeof a &&
              ((c = a.call(c, this)),
              (c = c.series ? c : new e(this.chart, this, a))));
          return c;
        },
        linkPoints: function () {
        ...
        addControlPoints: function () {
          ...
          (a || []).forEach(function (b, d) {
            b = q(this.options.controlPointOptions, b);
            b.index || (b.index = d);
            a[d] = b;
            this.controlPoints.push(new c(this.chart, this, b));
          }, this);
        },
        ...
        transform: function (a, b, c, f, g) {
          if (this.chart.inverted) {
            var l = b;
            b = c;
            c = l;
          }
          this.points.forEach(function (l, d) {
            this.transformPoint(a, b, c, f, g, d);
          }, this);
        },
        transformPoint: function (a, b, c, f, g, l) {
          var d = this.points[l];
          d.mock || (d = this.points[l] = e.fromPoint(d));
          d[a](b, c, f, g);
        },
        translate: function (a, b) {
          this.transform('translate', null, null, a, b);
        },
        translatePoint: function (a, b, c) {
          this.transformPoint('translate', null, null, a, b, c);
        },
        translateShape: function (a, b) {
          ...
          f[this.collection][this.index].point = this.options.point;
        },
        rotate: function (a, b, c) {
          this.transform('rotate', a, b, c);
        },
        scale: function (a, b, c, f) {
          this.transform('scale', a, b, c, f);
        },
  ...
  m(
    e,
    'annotations/controllable/markerMixin.js',
    [e['parts/Globals.js'], e['parts/Utilities.js']],
    function (d, c) {
      var e = c.addEvent,
        k = c.defined,
        ...
        v = {
          arrow: {
            ...
            markerHeight: 10,
            children: [
              { tagName: 'path', d: 'M 0 0 L 10 5 L 0 10 Z', strokeWidth: 0 },
            ],
          },
          'reverse-arrow': {
            tagName: 'marker',
            ...
            markerHeight: 10,
            children: [
              { tagName: 'path', d: 'M 0 5 L 10 0 L 10 10 Z', strokeWidth: 0 },
            ],
          },
        };
      d.SVGRenderer.prototype.addMarker = function (a, c) {
        ...
        d.children = c.children.map(function (a) {
          return b(f, a);
        });
        c = this.definition(
          b(
      ...
      c = {
        ...
        markerStartSetter: c('marker-start'),
        setItemMarkers: function (a) {
          var c = a.options,
            d = a.chart,
            f = d.options.defs,
            g = c.fill,
            l = k(g) && 'none' !== g ? g : c.stroke;
      ...
      e(d.Chart, 'afterGetContainer', function () {
        this.options.defs = b(v, this.options.defs || {});
        t(
          this.options.defs,
          function (a) {
            'marker' === a.tagName &&
              !1 !== a.render &&
              this.renderer.addMarker(a.id, a);
          },
          this,
        );
      });
  ...
  m(
    ...
    [
      e['parts/Globals.js'],
      e['parts/Utilities.js'],
      e['annotations/controllable/controllableMixin.js'],
      e['annotations/controllable/markerMixin.js'],
    ],
    function (d, c, e, k) {
      var b = c.extend;
      c = c.merge;
      var t = 'rgba(192,192,192,' + (d.svg ? 0.0001 : 0.002) + ')';
      d = function (b, c, a) {
        this.init(b, c, a);
      ...
      c(!0, d.prototype, e, {
        ...
        toD: function () {
          ...
          var c = this.points,
            ...
            d = a,
            e = c[0],
            f = d && this.anchor(e).absolutePosition,
            g = 0,
            l = 2;
          for (b = f && ['M', f.x, f.y]; ++g < a && d; )
            (e = c[g]),
              (d = e.command || 'L'),
              (f = this.anchor(e).absolutePosition),
              'Z' === d ?
                (b[++l] = d)
              : (d !== c[g - 1].command && (b[++l] = d),
                (b[++l] = f.x),
                (b[++l] = f.y)),
              (d = e.series.visible);
          return d ?
              this.chart.renderer.crispLine(b, this.graphic.strokeWidth())
            : null;
        },
        shouldBeDrawn: function () {
        ...
        render: function (c) {
          ...
          e.render.call(this);
          b(this.graphic, {
            markerStartSetter: k.markerStartSetter,
            markerEndSetter: k.markerEndSetter,
          });
        ...
        redraw: function (b) {
          var c = this.toD(),
            a = b ? 'animate' : 'attr';
          c ?
            (this.graphic[a]({ d: c }), this.tracker[a]({ d: c }))
  ...
  m(
    e,
    'annotations/controllable/ControllableRect.js',
    [
      e['parts/Utilities.js'],
      e['annotations/controllable/controllableMixin.js'],
      e['annotations/controllable/ControllablePath.js'],
    ],
    function (d, c, e) {
      d = d.merge;
      ...
      k.attrsMap = d(e.attrsMap, { width: 'width', height: 'height' });
      d(!0, k.prototype, c, {
        type: 'rect',
        translate: c.translateShape,
        render: function (b) {
  ...
  m(
    e,
    'annotations/controllable/ControllableLabel.js',
    [
      e['parts/Globals.js'],
      e['parts/Utilities.js'],
      e['annotations/controllable/controllableMixin.js'],
    ...
    function (d, c, e, k, b) {
      ...
      m.shapesWithoutBackground = ['connector'];
      m.alignedPosition = function (a, b) {
        var c = a.align,
          g = a.verticalAlign,
          f = (b.x || 0) + (a.x || 0),
          d = (b.y || 0) + (a.y || 0),
        ...
        e && (f += (b.width - (a.width || 0)) / e);
        'bottom' === g ? (n = 1) : 'middle' === g && (n = 2);
        n && (d += (b.height - (a.height || 0)) / n);
        return { x: Math.round(f), y: Math.round(d) };
      };
      m.justifiedOptions = function (a, b, c, d) {
        var g = c.align,
          f = c.verticalAlign,
          e = b.box ? 0 : b.padding || 0,
          n = b.getBBox();
        b = {
          align: g,
          verticalAlign: f,
        ...
        var l = d.y - a.plotTop;
        d = c + e;
        0 > d && ('right' === g ? (b.align = 'left') : (b.x = -d));
        d = c + n.width - e;
        d > a.plotWidth &&
          ('left' === g ? (b.align = 'right') : (b.x = a.plotWidth - d));
        d = l + e;
        0 > d && ('bottom' === f ? (b.verticalAlign = 'top') : (b.y = -d));
        d = l + n.height - e;
        d > a.plotHeight &&
          ('top' === f ?
      ...
      a(!0, m.prototype, e, {
        translatePoint: function (b, a) {
          e.translatePoint.call(this, b, a, 0);
        },
        translate: function (b, a) {
          var c = this.annotation.chart,
            d = this.annotation.userOptions,
            g = c.annotations.indexOf(this.annotation);
          g = c.options.annotations[g];
        ...
        render: function (b) {
          ...
          this.annotation.chart.styledMode ||
            ('contrast' === d.color &&
              (d.color = this.annotation.chart.renderer.getContrast(
                -1 < m.shapesWithoutBackground.indexOf(a.shape) ?
                  '#FFFFFF'
                : a.backgroundColor,
              )),
            this.graphic.css(a.style).shadow(a.shadow));
          a.className && this.graphic.addClass(a.className);
          this.graphic.labelrank = a.labelrank;
          e.render.call(this);
        },
        redraw: function (a) {
          var b = this.options,
            c = this.text || b.format || b.text,
            d = this.graphic,
            f = this.points[0];
          d.attr({
            text:
              c ?
                q(c, f.getLabelConfig(), this.annotation.chart)
              : b.formatter.call(f, this),
          });
          b = this.anchor(f);
          (c = this.position(b)) ?
            ((d.alignAttr = c),
            (c.anchorX = b.absolutePosition.x),
            (c.anchorY = b.absolutePosition.y),
            d[a ? 'animate' : 'attr'](c))
          : d.attr({ x: 0, y: -9999 });
          d.placed = !!c;
        ...
        anchor: function () {
          var b = e.anchor.apply(this, arguments),
            a = this.options.x || 0,
            c = this.options.y || 0;
          b.absolutePosition.x -= a;
          b.absolutePosition.y -= c;
          b.relativePosition.x -= a;
          b.relativePosition.y -= c;
          return b;
        },
        position: function (a) {
          var c = this.graphic,
            ...
            f = this.points[0],
            e = this.options,
            u = a.absolutePosition,
            r = a.relativePosition;
          if ((a = f.series.visible && k.prototype.isInsidePane.call(f))) {
            if (e.distance)
              var n = b.prototype.getPosition.call(
                { chart: d, distance: h(e.distance, 16) },
                c.width,
                c.height,
                {
                  plotX: r.x,
              ...
              e.positioner ?
                (n = e.positioner.call(this))
              : ((f = { x: u.x, y: u.y, width: 0, height: 0 }),
                (n = m.alignedPosition(
                  t(e, { width: c.width, height: c.height }),
                  f,
                )),
                'justify' === this.options.overflow &&
                  (n = m.alignedPosition(m.justifiedOptions(d, c, e, n), f)));
            e.crop &&
              ((e = n.x - d.plotLeft),
              (f = n.y - d.plotTop),
              (a =
                d.isInsidePlot(e, f) &&
                d.isInsidePlot(e + c.width, f + c.height)));
          }
          return a ? n : null;
        },
      });
      d.SVGRenderer.prototype.symbols.connector = function (b, a, c, d, e) {
        var f = e && e.anchorX;
        e = e && e.anchorY;
        var g = c / 2;
        if (B(f) && B(e)) {
          ...
          0 > A && (A = -d - A);
          A < c && (g = f < b + c / 2 ? A : c - A);
          e > a + d ? n.push('L', b + g, a + d)
          : e < a ? n.push('L', b + g, a)
          : f < b ? n.push('L', b, a + d / 2)
          : f > b + c && n.push('L', b + c, a + d / 2);
        }
        return n || [];
      };
      return m;
  ...
  m(
    e,
    'annotations/controllable/ControllableImage.js',
    [
      e['parts/Utilities.js'],
      e['annotations/controllable/controllableMixin.js'],
    ...
    function (d, c, e) {
      ...
      d(!0, k.prototype, c, {
        ...
        redraw: function (b) {
          ...
          if ((d = e.prototype.position.call(this, d)))
            this.graphic[b ? 'animate' : 'attr']({ x: d.x, y: d.y });
          else this.graphic.attr({ x: 0, y: -9e9 });
          this.graphic.placed = !!d;
          c.redraw.call(this, b);
        },
  ...
  m(
    e,
    'annotations/annotations.src.js',
    [
      e['parts/Globals.js'],
      e['parts/Utilities.js'],
      e['annotations/controllable/controllableMixin.js'],
      e['annotations/controllable/ControllableRect.js'],
      e['annotations/controllable/ControllableCircle.js'],
      e['annotations/controllable/ControllablePath.js'],
      e['annotations/controllable/ControllableImage.js'],
      e['annotations/controllable/ControllableLabel.js'],
      e['annotations/eventEmitterMixin.js'],
      e['annotations/MockPoint.js'],
      e['annotations/ControlPoint.js'],
    ],
    function (d, c, e, k, b, m, q, v, a, h, C) {
      var f = c.addEvent,
        g = c.defined,
      ...
      var w = d.fireEvent,
        ...
        y = (d.Annotation = function (b, a) {
          ...
          this.userOptions = a;
          a = this.getLabelsAndShapesOptions(this.options, a);
          this.options.labels = a.labels;
          this.options.shapes = a.shapes;
          this.init(b, this.options);
        });
      r(!0, y.prototype, e, a, {
        ...
        setClipAxes: function () {
          var a = this.chart.xAxis,
            b = this.chart.yAxis,
            c = D(
              (this.options.labels || []).concat(this.options.shapes || []),
              function (c, d) {
                return [
                  a[d && d.point && d.point.xAxis] || c[0],
                  b[d && d.point && d.point.yAxis] || c[1],
                ];
              },
              [],
            );
        ...
        destroy: function () {
          ...
          p(b.labelCollectors, this.labelCollector);
          a.destroy.call(this);
          e.destroy.call(this);
          l(this, b);
        },
        ...
        update: function (a) {
          var b = this.chart,
            ...
            d = b.annotations.indexOf(this);
          a = r(!0, this.userOptions, a);
          a.labels = c.labels;
          a.shapes = c.shapes;
          this.destroy();
          this.constructor(b, a);
          b.options.annotations[d] = a;
          this.isUpdating = !0;
          this.redraw();
          this.isUpdating = !1;
          w(this, 'afterUpdate');
        ...
        initShape: function (a, b) {
          ...
          b = new y.shapesMap[a.type](this, a, b);
          b.itemType = 'shape';
          this.shapes.push(b);
          return b;
        },
        ...
        redrawItem: function (a, b) {
          ...
          a.shouldBeDrawn() ?
            ...
            a.redraw(n(b, !0) && a.graphic.placed),
            a.points.length && this.adjustVisibility(a))
          : this.destroyItem(a);
        },
      ...
      y.shapesMap = { rect: k, circle: b, path: m, image: q };
      y.types = {};
      y.MockPoint = h;
      y.ControlPoint = C;
      d.extendAnnotation = function (a, b, c, d) {
        ...
        a.prototype.defaultOptions = r(a.prototype.defaultOptions, d || {});
      };
      z(x, {
        ...
        removeAnnotation: function (a) {
          ...
          c &&
            (w(c, 'remove'),
            p(this.options.annotations, c.options),
            p(b, c),
            c.destroy());
        },
      ...
      x.collectionsWithUpdate.push('annotations');
      x.collectionsWithInit.annotations = [x.addAnnotation];
      ...
      c(d.Pointer.prototype, 'onContainerMouseDown', function (a) {
          ...
          (d.navigation = {
            ...
            update: function (c, d) {
              this.updates.forEach(function (e) {
                e.update.call(e.context, c, d);
              });
            },
          });
      },
      addUpdate: function (d, c) {
        c.navigation || this.initUpdate(c);
        c.navigation.updates.push({ update: d, context: c });
      },
    };
  });
  m(
    e,
    'annotations/navigationBindings.js',
    [e['parts/Globals.js'], e['parts/Utilities.js'], e['mixins/navigation.js']],
    function (d, c, e) {
      function k(b) {
        var c =
          b.prototype.defaultOptions.events &&
          b.prototype.defaultOptions.events.click;
        l(!0, b.prototype.defaultOptions.events, {
          click: function (b) {
            var d = this,
              e = d.chart.navigationBindings,
              f = e.activeAnnotation;
            c && c.click.call(d, b);
            f !== d ?
              (e.deselectAnnotation(),
              (e.activeAnnotation = d),
              d.setControlPointsVisibility(!0),
              a(e, 'showPopup', {
                annotation: d,
                formType: 'annotation-toolbar',
                options: e.annotationToFields(d),
                onSubmit: function (a) {
                  var b = {};
                  'remove' === a.actionType ?
                    ((e.activeAnnotation = !1), e.chart.removeAnnotation(d))
                  : (e.fieldsToOptions(a.fields, b),
                    e.deselectAnnotation(),
                    (a = b.typeOptions),
                    'measure' === d.options.type &&
      ...
      var b = c.addEvent,
        ...
        u = d.doc,
        r = d.win;
      d.NavigationBindings = function (a, b) {
        this.chart = a;
        this.options = b;
        this.eventsToUnbind = [];
        this.container = u.getElementsByClassName(
      ...
      q(d.NavigationBindings.prototype, {
        initEvents: function () {
          var a = this,
            c = a.chart,
            d = a.container,
          ...
          [].forEach.call(d, function (c) {
            a.eventsToUnbind.push(
              b(c, 'click', function (b) {
                ...
                c && a.bindingsButtonClick(c.button, c.events, b);
              }),
            );
          });
          p(e.events || {}, function (c, d) {
            C(c) && a.eventsToUnbind.push(b(a, d, c));
          });
          a.eventsToUnbind.push(
            b(c.container, 'click', function (b) {
              !c.cancelClick &&
          ...
          a.eventsToUnbind.push(
            b(c.container, 'mousemove', function (b) {
        ...
        bindingsButtonClick: function (b, c, d) {
          var e = this.chart;
          this.selectedButtonElement &&
            (a(this, 'deselectButton', { button: this.selectedButtonElement }),
            this.nextEvent &&
        ...
        bindingsChartClick: function (b, c) {
          b = this.chart;
          ...
          d &&
            ...
            : ((this.currentUserDetails = d.start.call(this, c)),
              d.steps ?
                ((this.stepIndex = 0),
                (this.steps = !0),
                (this.mouseMoveEvent = this.nextEvent =
        ...
        fieldsToOptions: function (a, b) {
          p(a, function (a, c) {
            var d = parseFloat(a),
              ...
              g = b,
              n = e.length - 1;
            !f(d) || a.match(/px/g) || c.match(/format/g) || (a = d);
            '' !== a &&
              'undefined' !== a &&
        ...
        annotationToFields: function (a) {
          function b(c, d, e, l) {
            if (
              e &&
              -1 === k.indexOf(d) &&
              (0 <= (e.indexOf && e.indexOf(d)) || e[d] || !0 === e)
            )
              if (h(c))
                (l[d] = []),
                ...
                var w = {};
                h(l) ? (l.push(w), (w[d] = {}), (w = w[d])) : (l[d] = w);
                p(c, function (a, c) {
                  b(a, c, 0 === d ? e : f[d], w);
                });
              } else
                'format' === d ?
                  (l[d] = [B(c, a.labels[0].points[0]).toString(), 'text'])
                : h(l) ? l.push([c, n(c)])
                : (l[d] = [c, n(c)]);
          }
          var c = a.options,
            e = d.NavigationBindings.annotationsEditable,
            f = e.nestedOptions,
            n = this.utils.getFieldType,
            l = z(
              c.type,
              c.shapes && c.shapes[0] && c.shapes[0].type,
              c.labels && c.labels[0] && c.labels[0].itemType,
              'label',
            ),
            k = d.NavigationBindings.annotationsNonEditable[c.langKey] || [],
            u = { langKey: c.langKey, type: l };
          p(c, function (a, d) {
            'typeOptions' === d ?
              ((u[d] = {}),
              p(c[d], function (a, c) {
        ...
        utils: {
          ...
          getFieldType: function (a) {
            return { string: 'text', number: 'number', boolean: 'checkbox' }[
              typeof a
            ];
          },
        },
      ...
      d.Chart.prototype.initNavigationBindings = function () {
        ...
        a &&
          ...
          ((this.navigationBindings = new d.NavigationBindings(
            this,
            a.navigation,
          )),
      ...
      b(d.Chart, 'load', function () {
        this.initNavigationBindings();
      });
      b(d.Chart, 'destroy', function () {
        this.navigationBindings && this.navigationBindings.destroy();
      });
      b(d.NavigationBindings, 'deselectButton', function () {
        this.selectedButtonElement = null;
      });
      b(d.Annotation, 'remove', function () {
        this.chart.navigationBindings &&
          this.chart.navigationBindings.deselectAnnotation();
      });
      d.Annotation &&
        (k(d.Annotation),
        p(d.Annotation.types, function (a) {
          k(a);
        }));
      d.setOptions({
        lang: {
                          ...
                          controlPoints: [
                            {
                              positioner: function (a) {
                                var b = d.Annotation.MockPoint.pointToPixels(
                                  a.points[0],
                                );
                                a = a.options.r;
                                return {
                              ...
                              events: {
                                drag: function (a, b) {
                                  ...
                                  b.setRadius(
                                    Math.max(
                                      b.options.r + a.y / Math.sin(Math.PI / 4),
                                      5,
                                    ),
                                  );
                                  c.options.shapes[0] =
                    ...
                    shapes: [
                      {
                        r: Math.max(
                          Math.sqrt(
                            Math.pow(e ? c - a.chartX : d - a.chartX, 2) +
                              Math.pow(e ? d - a.chartY : c - a.chartY, 2),
                          ),
                          5,
                        ),
                      },
                  ...
                  l(
                    {
                      ...
                      controlPoints: [
                        {
                          positioner: function (a) {
                            a = d.Annotation.MockPoint.pointToPixels(
                              a.shapes[0].points[2],
                            );
                          ...
                          events: {
                            drag: function (b) {
                              var c = this.chart.pointer.getCoordinates(a),
                                d = c.xAxis[0].value;
                              c = c.yAxis[0].value;
                              var e = b.options.shapes[0].points;
                              e[1].x = d;
                              e[2].x = d;
                              e[2].y = c;
                              e[3].y = c;
                              b.options.shapes[0].points = e;
                              b.redraw(!1);
                            },
                          },
                        },
                    ...
                    c.bindings.rectangleAnnotation.annotationsOptions,
                  ),
                );
              },
              steps: [
                            ...
                            },
                            {
                              ...
                              positioner: function (a) {
                                return a.graphic.placed ?
                                    {
                                      x:
                                        a.graphic.alignAttr.x -
                                        this.graphic.width / 2,
                                      y:
                                        a.graphic.alignAttr.y -
                                        this.graphic.height / 2,
                                    }
                                  : { x: 0, y: -9e7 };
                              },
  ...
  m(
    ...
    function (d, c) {
      ...
      c = c.wrap;
      var C = /\d/g;
      c(d.Pointer.prototype, 'onContainerMouseDown', function (a, b) {
        var c = b.target && b.target.className;
        (v(c) && 0 <= c.indexOf('highcharts-popup-field')) ||
          a.apply(this, Array.prototype.slice.call(arguments, 1));
      });
      ...
      d.Popup.prototype = {
        init: function (a, b) {
          this.container = k('div', { className: 'highcharts-popup' }, null, a);
        ...
        addColsContainer: function (a) {
          ...
          k('div', { className: 'highcharts-popup-rhs-col-wrapper' }, null, a);
        ...
        addInput: function (a, b, c, d) {
          ...
          b = 'highcharts-' + b + '-' + e;
          b.match(C) ||
            k('label', { innerHTML: f[e] || e, htmlFor: b }, null, c);
          k(
            'input',
            {
              name: b,
            ...
            null,
            c,
          ).setAttribute('highcharts-data-name', a);
        },
        addButton: function (a, b, c, d, h) {
          var f = this,
            g = this.closePopup,
            l = this.getFields;
          var p = k('button', { innerHTML: b }, null, a);
        ...
        showPopup: function () {
          ...
          0 <= a.className.indexOf('highcharts-annotation-toolbar') &&
            (a.classList.remove('highcharts-annotation-toolbar'),
        ...
        annotations: {
          addToolbar: function (a, b, c) {
            var d = this,
              ...
              g = this.showForm;
            -1 === f.className.indexOf('highcharts-annotation-toolbar') &&
            ...
            k(
              ...
              {
                innerHTML: h(
                  e[b.langKey] || b.langKey,
                  b.shapes && b.shapes[0].type,
                ),
              },
              null,
              f,
            );
            var l = this.addButton(
              f,
          ...
          addForm: function (a, b, c, d) {
            ...
            this.addButton(
              l,
              d ? f.addButton || 'add' : f.saveButton || 'save',
              d ? 'add' : 'save',
              c,
              e,
            );
          },
          addFormFields: function (b, c, d, e, h, u) {
            var f = this,
            ...
            a(e, function (a, e) {
              ...
              q(a) &&
                (!m(a) || (m(a) && q(a[0])) ?
                  ((x = p[e] || e),
                  x.match(C) || h.push([!0, x, b]),
                  g.call(f, b, c, z, a, h, !1))
                : h.push([f, z, 'annotation', b, a]));
            });
            u &&
              ((h = h.sort(function (a) {
        ...
        indicators: {
          addForm: function (a, b, c) {
            ...
            b = this.popup.container.querySelectorAll(
          ...
          addIndicatorList: function (b, c, d) {
            var f = this,
              g = c.querySelectorAll('.highcharts-popup-lhs-col')[0];
            c = c.querySelectorAll('.highcharts-popup-rhs-col')[0];
            var l = 'edit' === d,
              h = l ? b.series : b.options.plotOptions,
            ...
            var t = c.querySelectorAll('.highcharts-popup-rhs-col-wrapper')[0];
            a(h, function (a, c) {
              var d = a.options;
              if (a.params || (d && d.params)) {
                var g = f.indicators.getNameType(a, c),
                  p = g.type;
                m = k(
                  'li',
                  { className: 'highcharts-indicator-list', innerHTML: g.name },
                  null,
                  q,
                );
                ['click', 'touchstart'].forEach(function (c) {
                  e(m, c, function () {
                    n.call(f, b, l ? a : h[p], g.type, t);
                    l &&
                      a.options &&
                      k(
                        'input',
                        {
                          type: 'hidden',
                          name: 'highcharts-id-' + p,
                          value: a.options.id,
                        },
                        null,
                        t,
                      ).setAttribute('highcharts-data-series-id', a.options.id);
                  });
                });
              }
            });
            0 < q.childNodes.length && q.childNodes[0].click();
          },
          ...
          listAllSeries: function (a, c, d, e, h) {
            a = 'highcharts-' + c + '-type-' + a;
            var f;
            k('label', { innerHTML: this.lang[c] || c, htmlFor: a }, null, e);
            var g = k(
              'select',
              { name: a, className: 'highcharts-popup-field' },
              null,
              e,
            );
            ...
            d.series.forEach(function (a) {
              ...
              !f.params &&
                f.id &&
                'highcharts-navigator-series' !== f.id &&
                k(
                  'option',
                  { innerHTML: f.name || f.id, value: f.id },
                  null,
                  g,
                );
            });
          ...
          addFormFields: function (a, b, c, d) {
            ...
            k(
              'input',
              { type: 'hidden', name: 'highcharts-type-' + c, value: c },
              null,
              d,
            );
            this.indicators.listAllSeries.call(
              ...
              a,
              d,
              b.linkedParent && e.volumeSeriesID,
            );
            e.volumeSeriesID &&
              this.indicators.listAllSeries.call(
                this,
                ...
                a,
                d,
                b.linkedParent && b.linkedParent.options.id,
              );
          ...
          addParamInputs: function (b, c, d, e, h) {
            ...
            a(d, function (a, d) {
              ...
              q(a) ?
                g.call(f, b, k, a, e, h)
              : 'params.volumeSeriesID' !== k &&
                l.call(f, k, e, h, [a, 'text']);
            });
          },
          getAmount: function () {
            var b = 0;
        ...
        tabs: {
          ...
          addMenuItem: function (a, b) {
            ...
            b = k(
              'span',
              { innerHTML: e[a + 'Button'] || a, className: d },
              null,
              c,
            );
          ...
          selectTab: function (a, b) {
            var c = this.popup.container.querySelectorAll(
              '.highcharts-tab-item-content',
            );
      ...
      e(d.NavigationBindings, 'showPopup', function (a) {
        this.popup ||
          (this.popup = new d.Popup(
      ...
      e(d.NavigationBindings, 'closePopup', function () {
        this.popup && this.popup.closePopup();
      });
    },
  );
  m(e, 'masters/modules/annotations.src.js', [], function () {});
});
