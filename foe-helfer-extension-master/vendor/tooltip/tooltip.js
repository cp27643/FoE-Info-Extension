...
!(function ($) {
  ...
  Tooltip.prototype = {
    ...
    setContent: function () {
      ...
      if (this.options.headLine) {
        $tip
          .find('h3')
          [this.options.html ? 'html' : 'text'](this.options.headLine)
          .css('display', 'block');
      }
    ...
    toggle: function (e) {
      var self =
        e ? $(e.currentTarget)[this.type](this._options).data(this.type) : this;
  ...
  $.fn.tooltip.defaults = {
    ...
    extraClass: '',
    template:
      '<div class="tooltip"><div class="tooltip-arrow"></div><h3></h3><div class="tooltip-inner"></div></div>',
    trigger: 'hover focus',
    title: '',
    headLine: '',
    delay: 0,
