...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ?
    factory(exports, require('dexie'))
  : typeof define === 'function' && define.amd ?
    define(['exports', 'dexie'], factory)
  ...
  ***************************************************************************** */
    ...
    !(function (e, n) {
      ...
      function hasConstructorOf(n, t) {
        ...
        return 'function' != typeof i ?
            null === t
          : 'function' == typeof i && null !== t && a.call(i) === a.call(t);
      }
      function isPlainObject(e) {
        return (
          !(!e || 'Object' !== toStringTag(e)) &&
          (!s(e) || hasConstructorOf(e, Object))
        );
      }
      function isObject(n) {
      ...
      function Typeson(o) {
        ...
        var f = (this.parse = function (e, n, t) {
          return (
            (t = Object.assign({}, o, t, { parse: !0 })), h(JSON.parse(e, n), t)
          );
        });
        ...
        var l = (this.encapsulate = function (y, p, f) {
          var l = (f = Object.assign({ sync: !0 }, o, f)).sync,
            h = {},
            v = [],
            d = [],
            b = [],
          ...
          function finish(e) {
            ...
            if (n.length) {
              ...
              e && isPlainObject(e) && !e.hasOwnProperty('$types') ?
                (e.$types = h)
              : (e = { $: e, $types: { $: h } });
            } else
              isObject(e) &&
          ...
          return (
            ...
            : f.stringification && l ? [finish(T)]
            : l ? finish(T)
            : Promise.resolve(finish(T))
          );
          ...
          function _encapsulate(n, t, o, c, a, u, y) {
            var p = void 0,
              ...
              O =
                ...
                : null;
            if (b in { string: 1, boolean: 1, number: 1, undefined: 1 })
              return (
                (
                  void 0 === t ||
                  ('number' === b && (isNaN(t) || t === -1 / 0 || t === 1 / 0))
                ) ?
                  (p = replace(n, t, c, a, !1, u, O)) !== t &&
                  (l = { replaced: p })
                : (p = t),
                O && O(),
                p
            ...
            var g = isPlainObject(t),
              P = i(t),
              j =
                ((g || P) && (!s.length || c.replaced)) || c.iterateIn ?
                  t
                : replace(n, t, c, a, g || P, null, O),
              S = void 0;
            if (
              (j !== t ? ((p = j), (l = { replaced: j }))
              : P || 'array' === c.iterateIn ?
                ((S = new Array(t.length)), (l = { clone: S }))
              : g || 'object' === c.iterateIn ? (l = { clone: (S = {}) })
              : '' === n && hasConstructorOf(t, TypesonPromise) ?
                (a.push([n, t, o, c, void 0, void 0, c.type]), (p = t))
              : (p = t),
              O && O(),
              f.iterateNone)
            )
                ...
                _adaptBuiltinStateObjectProperties(
                  ...
                  function () {
                    ...
                    hasConstructorOf(n, TypesonPromise) ?
                      a.push([r, n, !!o, c, S, e, c.type])
                    : void 0 !== n && (S[e] = n);
                  },
                );
              }),
                O && O({ endIterateOwn: !0, end: !0 });
          ...
          function replace(e, n, t, r, i, o, u) {
            for (var y = i ? s : c, p = y.length; p--; ) {
              ...
              if (f.test(n, t)) {
                ...
                return (
                  Object.assign(t, { type: v, replaced: !0 }),
                  (!l && f.replaceAsync) || f.replace ?
                    (u && u({ replacing: !0 }),
                    _encapsulate(
                      e,
                      f[l || !f.replaceAsync ? 'replace' : 'replaceAsync'](
                        n,
                        t,
                      ),
                      O && 'readonly',
        ...
        var h = (this.revive = function (e, t) {
          var s = (t = Object.assign({ sync: !0 }, o, t)).sync,
            c = e && e.$types,
            u = !0;
          if (!c) return e;
          if (!0 === c) return e.$;
          ...
          var y = [],
            ...
            f = (function _revive(e, t, o, s, f, l) {
              ...
              if (i(t) || isPlainObject(t)) {
                ...
                for (
                  ...
                  var d = n(y[0], 4),
                    ...
                    T = d[3],
                    g = getByKeyPath(b, O);
                  if (hasConstructorOf(g, Undefined)) m[T] = void 0;
                  else {
                    if (void 0 === g) break;
                    m[T] = g;
                  }
              ...
              return [].concat(h).reduce(function (e, n) {
                ...
                return t[
                  j && t.revive ? 'revive'
                  : !j && t.reviveAsync ? 'reviveAsync'
                  : 'revive'
                ](e, p);
              }, t);
            })('', e, null, t);
          return (
            isThenable((f = hasConstructorOf(f, Undefined) ? void 0 : f)) ?
              s && t.throwOnBadSyncType ?
                (function () {
                  throw new TypeError(
                    'Sync method requested but async result obtained',
                  );
              ...
              [].concat(e).forEach(function R(e) {
                ...
                e &&
                  r(e).forEach(function (t) {
                    ...
                    if (Typeson.JSON_TYPES.includes(t))
                      throw new TypeError(
                    ...
                    if (
                      ...
                      if ('function' == typeof r) {
                        ...
                        i(r) &&
                          (r = { test: r[0], replace: r[1], revive: r[2] });
                      var f = { type: t, test: r.test.bind(r) };
                      r.replace && (f.replace = r.replace.bind(r)),
                        r.replaceAsync &&
                          (f.replaceAsync = r.replaceAsync.bind(r));
                      var l =
                        'number' == typeof n.fallback ? n.fallback
                        : n.fallback ? 0
                        : 1 / 0;
                      if (
                        (r.testPlainObjects ?
                        ...
                        var h = {};
                        r.revive && (h.revive = r.revive.bind(r)),
                          r.reviveAsync &&
                            (h.reviveAsync = r.reviveAsync.bind(r)),
                          (a[t] = h);
                      }
                      y[t] = r;
                    }
      ...
      return (
        ...
        (Typeson.isUserObject = function isUserObject(e) {
        ...
        (Typeson.getJSONType = function (n) {
          return (
            null === n ? 'null'
            : i(n) ? 'array'
            : void 0 === n ? 'undefined'
  ...
  var structuredCloning = createCommonjsModule(function (module, exports) {
    !(function (e, t) {
      ...
      function hasConstructorOf(t, n) {
        ...
        return 'function' != typeof i ?
            null === n
          : 'function' == typeof i && null !== n && c.call(i) === c.call(n);
      }
      function isPlainObject(e) {
        return (
          !(!e || 'Object' !== toStringTag(e)) &&
      ...
      function Typeson(o) {
        ...
        var l = (this.parse = function (e, t, n) {
          return (
            (n = Object.assign({}, o, n, { parse: !0 })), v(JSON.parse(e, t), n)
          );
        });
          ...
          function _encapsulate(t, n, o, a, c, u, f) {
            var p = void 0,
              ...
              b =
                ...
                : null;
            if (g in { string: 1, boolean: 1, number: 1, undefined: 1 })
              return (
                (
                  void 0 === n ||
                  ('number' === g && (isNaN(n) || n === -1 / 0 || n === 1 / 0))
                ) ?
                  (p = replace(t, n, a, c, !1, u, b)) !== n &&
                  (y = { replaced: p })
                : (p = n),
                b && b(),
                p
            ...
            var O = isPlainObject(n),
              w = i(n),
              S =
                ((O || w) && (!s.length || a.replaced)) || a.iterateIn ?
                  n
                : replace(t, n, a, c, O || w, null, b),
              P = void 0;
            if (
              (S !== n ? ((p = S), (y = { replaced: S }))
              : w || 'array' === a.iterateIn ?
                ((P = new Array(n.length)), (y = { clone: P }))
              : O || 'object' === a.iterateIn ? (y = { clone: (P = {}) })
              : '' === t && hasConstructorOf(n, TypesonPromise) ?
                (c.push([t, n, o, a, void 0, void 0, a.type]), (p = n))
              : (p = n),
              b && b(),
              l.iterateNone)
            )
            ...
            if (a.iterateIn) {
              var j = function _loop(e) {
                ...
                _adaptBuiltinStateObjectProperties(a, r, function () {
                  ...
                  hasConstructorOf(i, TypesonPromise) ?
                    c.push([r, i, !!o, a, P, e, a.type])
                  : void 0 !== i && (P[e] = i);
                });
              };
              for (var A in n) j(A);
              b && b({ endIterateIn: !0, end: !0 });
            } else
              r(n).forEach(function (e) {
                ...
                _adaptBuiltinStateObjectProperties(
                  ...
                  function () {
                    ...
                    hasConstructorOf(t, TypesonPromise) ?
                      c.push([r, t, !!o, a, P, e, a.type])
                    : void 0 !== t && (P[e] = t);
                  },
                );
              }),
                b && b({ endIterateOwn: !0, end: !0 });
            if (a.iterateUnsetNumeric) {
              for (
                ...
                N(B);
              b && b({ endIterateUnsetNumeric: !0, end: !0 });
            }
            return P;
          }
          function replace(e, t, n, r, i, o, u) {
            for (var f = i ? s : a, p = f.length; p--; ) {
              ...
              if (l.test(t, n)) {
                ...
                return (
                  Object.assign(n, { type: d, replaced: !0 }),
                  (!y && l.replaceAsync) || l.replace ?
                    (u && u({ replacing: !0 }),
                    _encapsulate(
                      e,
                      l[y || !l.replaceAsync ? 'replace' : 'replaceAsync'](
                        t,
                        n,
                      ),
                      b && 'readonly',
          ...
          var f = [],
            ...
            l = (function _revive(e, n, o, s, l, y) {
              ...
              if (i(n) || isPlainObject(n)) {
                ...
                for (
                  ...
                  var h = t(f[0], 4),
                    ...
                    T = h[3],
                    O = getByKeyPath(g, b);
                  if (hasConstructorOf(O, Undefined)) m[T] = void 0;
                  else {
                    if (void 0 === O) break;
                    m[T] = O;
                  }
              ...
              return [].concat(v).reduce(function (e, t) {
                ...
                return n[
                  S && n.revive ? 'revive'
                  : !S && n.reviveAsync ? 'reviveAsync'
                  : 'revive'
                ](e, p);
              }, n);
            })('', e, null, n);
          return (
            isThenable((l = hasConstructorOf(l, Undefined) ? void 0 : l)) ?
              ...
              [].concat(e).forEach(function R(e) {
                ...
                e &&
                  r(e).forEach(function (n) {
                    ...
                    if (Typeson.JSON_TYPES.includes(n))
                      throw new TypeError(
                        'Plain JSON object types are reserved as type names',
                      );
                    var r = e[n],
      ...
      (TypesonPromise.prototype.then = function (e, t) {
        ...
        (Typeson.unescapeKeyPathComponent = unescapeKeyPathComponent),
        (Typeson.getByKeyPath = getByKeyPath),
        (Typeson.getJSONType = function (t) {
          return (
            null === t ? 'null'
            : i(t) ? 'array'
            : void 0 === t ? 'undefined'
      ...
      var O = function encode(e, t, n) {
          for (
            var r = new Uint8Array(e, t, n), i = r.length, o = '', s = 0;
            s < i;
            s += 3
          )
            (o += b[r[s] >> 2]),
              (o += b[((3 & r[s]) << 4) | (r[s + 1] >> 4)]),
              (o += b[((15 & r[s + 1]) << 2) | (r[s + 2] >> 6)]),
              (o += b[63 & r[s + 2]]);
          return (
            i % 3 == 2 ?
        ...
        w = function decode(e) {
          ...
          for (
            var c = new ArrayBuffer(n), u = new Uint8Array(c), f = 0;
            f < t;
            f += 4
          )
            (i = m[e.charCodeAt(f)]),
              (o = m[e.charCodeAt(f + 1)]),
              (s = m[e.charCodeAt(f + 2)]),
              (a = m[e.charCodeAt(f + 3)]),
              (u[r++] = (i << 2) | (o >> 4)),
              (u[r++] = ((15 & o) << 4) | (s >> 2)),
              (u[r++] = ((3 & s) << 6) | (63 & a));
          return c;
        ...
        S = {
          arraybuffer: {
            ...
            replace: function replace(e, t) {
              ...
              return n > -1 ? { index: n } : (t.buffers.push(e), O(e));
            },
        ...
        n &&
          (j[e.toLowerCase()] = {
            ...
            replace: function replace(e, t) {
              ...
              return o > -1 ?
                  { index: o, byteOffset: r, length: i }
                : (t.buffers.push(n),
                  { encoded: O(n), byteOffset: r, length: i });
            },
      ...
      var A = {
          dataview: {
            ...
            replace: function replace(e, t) {
              ...
              var o = t.buffers.indexOf(n);
              return o > -1 ?
                  { index: o, byteOffset: r, byteLength: i }
                : (t.buffers.push(n),
                  { encoded: O(n), byteOffset: r, byteLength: i });
            },
            revive: function revive(e, t) {
              t.buffers || (t.buffers = []);
              var n = e.byteOffset,
      ...
      return [
        ...
        },
        {
          imagebitmap: {
            test: function test(e) {
              return (
                'ImageBitmap' === Typeson.toStringTag(e) ||
        ...
        N,
        {
          ...
          filelist: {
            ...
            revive: function revive(e) {
              ...
              return (
                (FileList.prototype.item = function (e) {
          ...
          blob: {
            ...
            replace: function replace(e) {
              ...
              if (
                ...
                throw new Error('Bad Blob access: ' + t.status);
              return t.send(), { type: e.type, stringContents: t.responseText };
            },
            revive: function revive(e) {
              var t = e.type,
                n = e.stringContents;
              return new Blob([string2arraybuffer(n)], { type: t });
            },
            replaceAsync: function replaceAsync(e) {
              return new Typeson.Promise(function (t, n) {
        ...
        'function' == typeof Map ? h : [],
        'function' == typeof Set ? g : [],
        'function' == typeof ArrayBuffer ? S : [],
        'function' == typeof Uint8Array ? j : [],
        'function' == typeof DataView ? A : [],
        'undefined' != typeof Intl ? C : [],
      );
    });
  });
                ...
                if (item.$types) {
                  ...
                  for (keyPath in types) {
                    ...
                    if (typeSpec && typeSpec.finalize) {
                      b = Dexie__default['default'].getByKeyPath(
                        item,
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                emptyExportJson = JSON.stringify(
                  emptyExport,
                  undefined,
                  ...
                  return __generator(this, function (_b) {
                    switch (_b.label) {
                      case 0:
                        ...
                        LIMIT =
                          options.numRowsPerChunk || DEFAULT_ROWS_PER_CHUNK;
                        emptyTableExport =
                          inbound ?
                            {
                        ...
                        emptyTableExportJson = JSON.stringify(
                          emptyTableExport,
                          undefined,
                          prettyJson ? 2 : undefined,
                        );
                        if (prettyJson) {
                          ...
                          //   ]
                          // }
                          emptyTableExportJson = emptyTableExportJson
                            .split('\n')
                            .join('\n    ');
                        }
                        posEndRowsArray = emptyTableExportJson.lastIndexOf(']');
                        slices.push(
                          emptyTableExportJson.substring(0, posEndRowsArray),
                        );
                        lastKey = null;
                        lastNumRows = 0;
                            ...
                            switch (_c.label) {
                              case 0:
                                if (progressCallback) {
                                  ...
                                  Dexie__default['default'].ignoreTransaction(
                                    function () {
                              ...
                              case 1:
                                ...
                                return [
                                  4 /*yield*/,
                                  Dexie__default['default'].waitFor(
                                    TSON.finalize(tsonValues),
                                  ),
                                ];
                              case 2:
                                _c.sent();
                              ...
                              case 3:
                                ...
                                lastKey =
                                  values.length > 0 ?
                                    Dexie__default['default'].getByKeyPath(
                      ...
                      case 3:
                        slices.push(
                          emptyTableExportJson.substr(posEndRowsArray),
                        ); // "]}"
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [3 /*break*/, 5];
          case 3:
            return [4 /*yield*/, db.transaction('r', db.tables, exportAll)];
          case 4:
            _a.sent();
            _a.label = 5;
          case 5:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            db.version(dbExport.databaseVersion).stores(
              extractDbSchema(dbExport),
            );
            ...
            switch (_b.label) {
              case 0:
                _loop_1 = function (tableExport) {
                  ...
                  return __generator(this, function (_d) {
                    switch (_d.label) {
                      case 0:
                        if (!tableExport.rows) return [2 /*return*/, 'break']; // Need to pull more!
                        if (
                          !tableExport.rows.incomplete &&
                        ...
                        if (!table) {
                          ...
                          else return [2 /*return*/, 'continue'];
                        }
                        if (
                          !options.acceptChangedPrimaryKey &&
                          tableSchemaStr.split(',')[0] !=
                      ...
                      case 1:
                        ...
                        return [3 /*break*/, 4];
                      case 2:
                        return [4 /*yield*/, table.bulkAdd(values, keys)];
                      case 3:
                        _d.sent();
                        _d.label = 4;
                      case 4:
              ...
              case 4:
                ...
                while (
                  ...
                  !dbExport.data[0].rows.incomplete
                ) {
              ...
              case 5:
                return [
                  4 /*yield*/,
                  Dexie__default['default'].waitFor(
                    jsonStream.pullAsync(CHUNK_SIZE),
                  ),
                ];
              case 6:
                _b.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (
              !options.acceptVersionDiff &&
              db.verno !== dbExport.databaseVersion
            ) {
          ...
          case 6:
            ...
            return [3 /*break*/, 9];
          case 7:
            return [4 /*yield*/, db.transaction('rw', db.tables, importAll)];
          case 8:
            _b.sent();
            _b.label = 9;
          case 9:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            stream =
              'slice' in exportedData ? JsonStream(exportedData) : exportedData;
            _a.label = 1;
          case 1:
            if (!!stream.eof()) return [3 /*break*/, 3];
  ...
  Dexie__default['default'].import = function (blob, options) {
