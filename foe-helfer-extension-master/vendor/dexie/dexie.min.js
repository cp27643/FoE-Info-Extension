(function (e, t) {
  ...
  var se = {},
    ...
    ge =
      ...
      : h.setImmediate ? setImmediate.bind(null, Ne)
      : h.MutationObserver ?
        function () {
        ...
        try {
          ...
          var e = (function e(t, n, r) {
            ...
            var i = '';
            {
              ...
              !1 === t._state &&
                (null != (o = t._value) ?
                  ((a = o.name || 'Error'), (u = o.message || o), (i = L(o, 0)))
                : ((a = o), (u = '')),
                n.push(a + (u ? ': ' + u : '') + i));
            }
            F &&
      ...
      try {
        ...
        if (
          (h.document && document.createEvent ?
            ((r = document.createEvent('Event')).initEvent(st, !0, !0), u(r, i))
  ...
  var Pt =
    ...
    (Kt.prototype.where = function (o) {
      ...
      var t = n.reduce(
        ...
        t = t[1];
      return (
        i ? this.where(i.name).equals(o[i.keyPath]).filter(t)
        : e ? this.filter(t)
        : this.where(n).equals('')
      );
    }),
        ...
        for (var o = null, a = v; a < y; ++a) {
          var u = (function (e, t, n, r, i, o) {
            for (
              ...
              if (c !== r[s])
                return (
                  i(e[s], n[s]) < 0 ? e.substr(0, s) + n[s] + n.substr(s + 1)
                  : i(e[s], r[s]) < 0 ? e.substr(0, s) + r[s] + n.substr(s + 1)
                  : 0 <= u ? e.substr(0, u) + t[u] + n.substr(u + 1)
                  : null
                );
              i(e[s], c) < 0 && (u = s);
            }
            return (
              a < r.length && 'next' === o ? e + n.substr(e.length)
              : a < e.length && 'prev' === o ? e.substr(0, n.length)
              : u < 0 ? null
  ...
  var Pn =
    ...
    (Kn.prototype.stores = function (e) {
      var t = this.db;
      this._cfg.storesSource =
        this._cfg.storesSource ? u(this._cfg.storesSource, e) : e;
      var e = t._versions,
        n = {},
        r = {};
      return (
  ...
  function Cn(f) {
    ...
    return je
      .race([
        t,
        ('undefined' == typeof navigator ? je.resolve()
        : (
        ...
        : Promise.resolve()
          ...
          return new je(function (s, n) {
            ...
            var c = f.name,
              l =
                h.autoSchema ? r.open(c) : r.open(c, Math.round(10 * f.verno));
  ...
  function jn(t) {
    ...
    function n(n) {
      return function (e) {
        ...
        return (
          t.done ? e
          : e && 'function' == typeof e.then ? e.then(r, i)
          : b(e) ? Promise.all(e).then(r, i)
          : r(e)
        );
      };
    }
              ...
              function o(n) {
                return Object.create(n, {
                  continue: {
                    value: function (e) {
                      null != e ?
                        n.continue(Dn(e, t.reverse ? f.MAX_KEY : f.MIN_KEY, r))
                      : t.unique ?
                        n.continue(
                          n.key
                            .slice(0, i)
                ...
                return (
                  ...
                  : e.getMany({ trans: t.trans, keys: n, cache: 'immutable' })
                    ...
                    var s = f.map(function (e, t) {
                      ...
                      return (
                        'delete' === c.type ? h.fire.call(a, e, o, l)
                        : 'add' === c.type || void 0 === o ?
            ...
            n = g(g({}, p), {
              mutate: function (e) {
                ...
                var t = e.trans,
                  ...
                  c = e.type,
                  t =
                    'deleteRange' === e.type ? [e.range]
                    : 'delete' === e.type ? [e.keys]
                    : e.values.length < 50 ? [[], e.values]
                    : [],
                  l = t[0],
                  f = t[1],
                  h = e.trans._cache;
  ...
  var Gn =
    ...
    (Hn.prototype._whenReady = function (e) {
      var n = this;
      return (
          this.idbdb && (this._state.openComplete || Oe.letThrough || this._vip)
        ) ?
          e()
        : new je(function (e, t) {
            if (n._state.openComplete)
      ...
      (this.on.ready.subscribe = p(this.on.ready.subscribe, function (i) {
        return function (n, r) {
          Hn.vip(function () {
            var t,
              e = o._state;
            e.openComplete ? (e.dbOpenError || je.resolve().then(n), r && i(n))
            : e.onReadyBeingFired ? (e.onReadyBeingFired.push(n), r && i(n))
            : (i(n),
              (t = o),
              r ||
                i(function e() {
          ...
          h = function () {
            ...
            s ||
              ...
              Promise.resolve(e).then(
                ...
                function (e) {
                  (p = s = !1), n.error && n.error(e), u.unsubscribe();
                },
              ));
          };
        return h(), u;
