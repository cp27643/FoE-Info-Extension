            ...
            f === c ?
              ...
              w < S &&
                ('auto' === C.overflowY ||
                  ...
                  'visible' === C.overflowY))
            : ((E =
                y < _ && ('auto' === C.overflowX || 'scroll' === C.overflowX)),
              w < S && ('auto' === C.overflowY || 'scroll' === C.overflowY));
          var M =
              E &&
              (Math.abs(b - r) <= l && T + y < _) -
                (Math.abs(m - r) <= l && !!T),
            O =
              D &&
              (Math.abs(v - a) <= l && x + w < S) -
                (Math.abs(g - a) <= l && !!x);
              ...
              return (
                se.forEach(function (t) {
                  ...
                  o.push({ multiDragElement: t, index: t.sortableIndex }),
                    (e =
                      de && t !== re ? -1
                      : de ? F(t, ':not(.' + n.options.selectedClass + ')')
                      : F(t)),
