var litHtml = (function (t) {
  ...
  function (t, e, n) {
    ...
    const s = new WeakMap(),
      ...
      l = {},
      a = {},
      u = `{{lit-${String(Math.random()).slice(2)}}}`,
      c = `\x3c!--${u}--\x3e`,
      h = new RegExp(`${u}|${c}`);
    class d {
      constructor(t, e) {
            ...
            if ((r++, 1 === t.nodeType)) {
              if (t.hasAttributes()) {
                const e = t.attributes,
                  { length: n } = e;
                let s = 0;
                for (let t = 0; t < n; t++) p(e[t].name, '$lit$') && s++;
                for (; s-- > 0; ) {
                  const e = a[l],
                    n = f.exec(e)[2],
                    s = n.toLowerCase() + '$lit$',
              ...
              'TEMPLATE' === t.tagName &&
                (s.push(t), (i.currentNode = t.content));
        ...
        for (; r < n.length; )
          if (((i = n[r]), m(i))) {
            for (; l < i.index; )
              l++,
                'TEMPLATE' === a.nodeName &&
                  (e.push(a), (s.currentNode = a.content)),
                null === (a = s.nextNode()) &&
                  ((s.currentNode = e.pop()), (a = s.nextNode()));
            if ('node' === i.type) {
      ...
      getHTML() {
        ...
        for (let s = 0; s < t; s++) {
          ...
          e +=
            null === o ?
              t + (n ? v : c)
            : t.substr(0, o.index) + o[1] + o[2] + '$lit$' + o[3] + u;
        }
    ...
    const y = (t) =>
      ...
      N = (t) => Array.isArray(t) || !(!t || !t[Symbol.iterator]);
    class b {
      constructor(t, e, n) {
        (this.dirty = !0),
          (this.element = t),
      ...
      _getValue() {
        ...
        for (let s = 0; s < e; s++) {
          ...
          if (void 0 !== e) {
            const t = e.value;
            if (y(t) || !N(t)) n += 'string' == typeof t ? t : String(t);
    ...
    class V {
      ...
      appendInto(t) {
        (this.startNode = t.appendChild(_())),
          (this.endNode = t.appendChild(_()));
      }
      insertAfterNode(t) {
      ...
      commit() {
        ...
        const t = this.__pendingValue;
        t !== l &&
          (y(t) ? t !== this.value && this.__commitText(t)
          : t instanceof x ? this.__commitTemplateResult(t)
          : t instanceof Node ? this.__commitNode(t)
          : N(t) ? this.__commitIterable(t)
          : t === a ? ((this.value = a), this.clear())
          : this.__commitText(t));
      }
      __insert(t) {
      ...
      __commitTemplateResult(t) {
        ...
        if (this.value instanceof g && this.value.template === e)
          ...
          const n = new g(e, t.processor, this.options),
            s = n._clone();
          n.update(t.values), this.__commitNode(s), (this.value = n);
        }
      }
      __commitIterable(t) {
        ...
        for (const i of t)
          (n = e[s]),
            void 0 === n &&
              ((n = new V(this.options)),
              e.push(n),
              0 === s ? n.appendIntoPart(this) : n.insertAfterPart(e[s - 1])),
            n.setValue(i),
            n.commit(),
            s++;
        s < e.length && ((e.length = s), this.clear(n && n.endNode));
      }
     ...
     */ const P = new (class {
      handleAttributeExpressions(t, e, n, s) {
        const i = e[0];
        if ('.' === i) {
          return new E(t, e.slice(1), n).parts;
        }
        return (
          '@' === i ? [new M(t, e.slice(1), s.eventContext)]
          : '?' === i ? [new T(t, e.slice(1), n)]
          : new b(t, e, n).parts
        );
      }
     ...
     */ function L(t) {
      ...
      const s = t.strings.join(u);
      return (
        (n = e.keyString.get(s)),
        void 0 === n &&
          ((n = new d(t, t.getTemplateElement())), e.keyString.set(s, n)),
    ...
    const H = new Map(),
      ...
      C = (t, e, n) => {
        ...
        void 0 === s &&
          (r(e, e.firstChild),
          O.set(e, (s = new V(Object.assign({ templateFactory: L }, n)))),
          s.appendInto(e)),
          s.setValue(t),
          s.commit();
      };
    ...
    const j = (t, ...e) => new x(t, e, 'html', P),
      ...
      I =
        ((W = (t) => (e) => {
          ...
          const n = k.get(e);
          if (void 0 !== n && y(t) && t === n.value && e.value === n.fragment)
            return;
          const s = document.createElement('template');
          s.innerHTML = t;
          const i = document.importNode(s.content, !0);
          e.setValue(i), k.set(e, { value: t, fragment: i });
        }),
        (...t) => {
          const e = W(...t);
          return s.set(e, !0), e;
