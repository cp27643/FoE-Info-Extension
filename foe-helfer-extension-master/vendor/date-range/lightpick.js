...
!(function (t, e) {
  'object' == typeof exports && 'object' == typeof module ?
    (module.exports = e())
  : 'function' == typeof define && define.amd ? define('Litepicker', [], e)
  : 'object' == typeof exports ? (exports.Litepicker = e())
  : (t.Litepicker = e());
})(window, function () {
  return (function (t) {
    var e = {};
            ...
            if ('string' == typeof e) {
              ...
              if (n) {
                var s = {
                  ...
                  r = null;
                -1 !== n.indexOf('MMM') &&
                  (a = this.MONTH_JS.map(function (t) {
                    return new Date(2019, t).toLocaleString(o, {
                      month: 'short',
                    });
                  })),
                  -1 !== n.indexOf('MMMM') &&
                    (r = this.MONTH_JS.map(function (t) {
                      return new Date(2019, t).toLocaleString(o, {
                        month: 'long',
                      });
                    }));
                ...
                if (f.test(e)) {
                  ...
                  a ?
                    (k = a.indexOf(g[s.month]))
                  : r && (k = r.indexOf(g[s.month]));
          ...
          (t.prototype.format = function (e, i) {
            ...
            if (n) {
              var s = null,
                a = null;
              -1 !== n.indexOf('MMM') &&
                (s = t.MONTH_JS.map(function (t) {
                  return new Date(2019, t).toLocaleString(i, {
                    month: 'short',
                  });
                })),
                n.indexOf('MMMM') &&
                  (a = t.MONTH_JS.map(function (t) {
                    return new Date(2019, t).toLocaleString(i, {
                      month: 'long',
                    });
                  }));
        ...
        a =
          ...
          function () {
            ...
            var o = Array(t),
              n = 0;
            for (e = 0; e < i; e++)
              for (var s = arguments[e], a = 0, r = s.length; a < r; a++, n++)
                o[n] = s[a];
            return o;
          },
        r =
        ...
        d = (function (t) {
          function e(e) {
            ...
            i.options.startDate &&
              ...
              n instanceof c.DateTime &&
                !isNaN(n.getTime()) &&
                (i.options.startDate = n),
              i.options.startDate &&
                a instanceof c.DateTime &&
                !isNaN(a.getTime()) &&
                (i.options.endDate = a),
            ...
            (e.prototype.parseInput = function () {
              if (this.options.elementEnd) {
                if (
                  ...
                  return [
                    new c.DateTime(this.options.element.value),
                    new c.DateTime(this.options.elementEnd.value),
                  ];
                ...
                if (
                  ...
                  return [new c.DateTime(this.options.element.value)];
              } else if (/\s\-\s/.test(this.options.element.value)) {
                var t = this.options.element.value.split(' - ');
                if (2 === t.length)
                  return [new c.DateTime(t[0]), new c.DateTime(t[1])];
              }
              return [];
            }),
            (e.prototype.updateInput = function () {
              if (this.options.element instanceof HTMLInputElement) {
                if (this.options.singleMode && this.options.startDate)
                  ...
                  : (this.options.element.value = t + ' - ' + e);
                }
                this.options.startDate ||
                  this.options.endDate ||
                ...
                if (this.shouldShown(i)) this.show(i);
                  ...
                  if (i.classList.contains(h.dayItem)) {
                    ...
                    if (
                      ...
                      (this.datePicked[this.datePicked.length] = new c.DateTime(
                        i.dataset.time,
                      )),
              ...
              if (
                ...
                ('function' == typeof this.options.onDayHover &&
                  this.options.onDayHover.call(
                    this,
                    c.DateTime.parseDateTime(o.dataset.time),
                    null === (e = o.classList.value) || void 0 === e ?
                      void 0
                    : e.split(/\s/),
                  ),
                this.shouldAllowMouseEnter(o))
              ) {
                if (
                ...
                for (
                  var p = this.picker.querySelectorAll('.' + h.dayItem),
                ...
                if (
                  (d.forEach(function (t) {
                    var e = new c.DateTime(t.dataset.time),
                      o = i.renderDay(e);
                    e.isBetween(s, a) && o.classList.add(h.isInRange),
                      (t.className = o.className);
                  }),
                  o.classList.add(h.isEndDate),
                  r ?
                    (n && n.classList.add(h.isFlipped),
                    o.classList.add(h.isFlipped))
                  : (n && n.classList.remove(h.isFlipped),
                    o.classList.remove(h.isFlipped)),
              ...
              switch (t.code) {
                case 'ArrowUp':
                  if (e.classList.contains(h.dayItem))
                    t.preventDefault(),
                      (i =
                        a(e.parentNode.childNodes).findIndex(function (t) {
                          return t === e;
                        }) - 7) > 0 &&
                        e.parentNode.childNodes[i] &&
                        e.parentNode.childNodes[i].focus();
                  break;
                case 'ArrowLeft':
                  e.classList.contains(h.dayItem) &&
                    e.previousSibling &&
                    (t.preventDefault(), e.previousSibling.focus());
                  break;
                case 'ArrowRight':
                  e.classList.contains(h.dayItem) &&
                    e.nextSibling &&
                    (t.preventDefault(), e.nextSibling.focus());
                  break;
                case 'ArrowDown':
                  var i;
                  if (e.classList.contains(h.dayItem))
    ...
    function (t, e, i) {
      ...
      var o = i(3);
      (e.Litepicker = o.Litepicker), i(9), (e.default = o.Litepicker);
    },
    function (t, e, i) {
      'use strict';
      var o =
        ...
        r = (function () {
          ...
          return (
            (t.prototype.render = function () {
              ...
              (t.className = s.containerMonths),
                s['columns' + this.options.numberOfColumns] &&
                  (t.classList.remove(s.columns2, s.columns3, s.columns4),
                  t.classList.add(s['columns' + this.options.numberOfColumns])),
                this.options.splitView && t.classList.add(s.splitView),
                this.options.showWeekNumbers &&
                  t.classList.add(s.showWeekNumbers);
              for (
                var e = this.calendars[0].clone(),
                  i = e.getMonth(),
                ...
                r.setDate(1),
                  this.options.splitView ?
                    (r = this.calendars[n].clone())
                  : r.setMonth(a),
                  t.appendChild(this.renderMonth(r)),
                  (n += 1);
              }
            ...
            (t.prototype.renderMonth = function (t) {
              ...
              if (this.options.dropdowns.months) {
                ...
                for (var p = 0; p < 12; p += 1) {
                  var d = document.createElement('option'),
                    u = new n.DateTime(
                      new Date(t.getFullYear(), p, 1, 0, 0, 0),
                    );
                  (d.value = String(p)),
                    ...
                    (d.disabled =
                      (this.options.minDate &&
                        u.isBefore(
                          new n.DateTime(this.options.minDate),
                          'month',
                        )) ||
                      (this.options.maxDate &&
                        u.isAfter(
                          new n.DateTime(this.options.maxDate),
                          'month',
                        ))),
              ...
              if (this.options.dropdowns.years) {
                ...
                if (t.getFullYear() > y)
                  ((d = document.createElement('option')).value = String(
                    t.getFullYear(),
                  )),
              ...
              (v.href = '#'),
                (v.className = s.buttonPreviousMonth),
                (v.innerHTML = this.options.buttonText.previousMonth);
              var b = document.createElement('a');
              (b.href = '#'),
                (b.className = s.buttonNextMonth),
                (b.innerHTML = this.options.buttonText.nextMonth);
              var w = document.createElement('span');
              (w.className = s.resetButton),
                (w.innerHTML = this.options.buttonText.reset),
                l.appendChild(v),
                l.appendChild(c),
                l.appendChild(b),
                this.options.useResetBtn &&
                  (w.addEventListener('click', this.options.resetBtnCallback),
                  l.appendChild(w)),
                this.options.minDate &&
                  i.isSameOrBefore(
                    new n.DateTime(this.options.minDate),
            ...
            (t.prototype.renderDay = function (t) {
              ...
              if (this.options.maxDays && 1 === this.datePicked.length) {
                ...
                t.isBefore(o) && i.classList.add(s.isLocked),
                  t.isAfter(a) && i.classList.add(s.isLocked);
              }
    ...
    function (t, e, i) {
      ...
      (a.Litepicker.prototype.show = function (t) {
        ...
        if (this.options.parentEl) {
          ...
          (c -= f.bottom),
            (c += s.height) + a.height > window.innerHeight &&
              s.top - f.top - s.height > 0 &&
              (u = s.top - f.top - s.height),
            (h -= f.left) + a.width > window.innerWidth &&
              s.right - f.right - a.width > 0 &&
              (m = s.right - f.right - a.width);
        } else
          (p = window.scrollX || window.pageXOffset),
            (d = window.scrollY || window.pageYOffset),
            c + a.height > window.innerHeight &&
              s.top - a.height > 0 &&
              (u = s.top - a.height),
            h + a.width > window.innerWidth &&
              s.right - a.width > 0 &&
              (m = s.right - a.width);
        (this.picker.style.top = (u || c) + d + 'px'),
          (this.picker.style.left = (m || h) + p + 'px'),
          (this.picker.style.right = null),
          (this.picker.style.bottom = null),
          'function' == typeof this.options.onShow &&
            this.options.onShow.call(this);
