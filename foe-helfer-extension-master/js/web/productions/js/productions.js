    ...
    if (Productions.RatingCurrentTab === 'Settings') {
      ...
      for (const type of Productions.Rating.Types) {
        ...
        if (type.includes('att_') || type.includes('def_')) {
          ...
          let twinType =
            type.includes('att_') ? 'def_' + coreType : 'att_' + coreType;
      ...
      h.push(
        '<input type="text" id="efficiencyBuildingFilter" size=20 placeholder="' +
      ...
      h.push(
        '<th data-type="ratinglist" class="is-number" data-export="' +
      ...
      for (const building of ratedBuildings) {
        ...
        h.push(
          `<tr class="${building.type === 'greatbuilding' ? 'gb ' : ''}${building.isLimited ? 'limited ' : ''}${building.highlight ? 'additional ' : ''}${building.isInInventory ? 'inventory-building ' : ''}size${buildingSize}">`,
        );
        h.push(
          '<td data-number="' +
