...
let Market = {
  ...
  Show: (event = true) => {
    if ($('#Market').length === 0) {
      ...
      $('#Market').on('click', '.custom-option', function () {
        ...
        Market.ScrollPositions[func] = $(this)
  ...
  CalcBody: () => {
    ...
    h.push(
      '<div style="float:right" class="text-right p5"><span class="btn" onclick="MarketOffers.Show(false)">' +
        i18n('Boxes.MarketOffers.Title') +
        '</span><br>',
    );
    h.push(
      '<span class="btn my-5" onclick="MarketOffers.ShowEvents(false)">' +
        i18n('Boxes.MarketOffers.Events') +
        '</span></div>',
    );
    ...
    h.push(
      '<th class="text-left">' + i18n('Boxes.Market.TradePartner') + '</th>',
    );
    h.push(
      '<th class="text-left">' + i18n('Boxes.Market.TradeForGoods') + '</th>',
    );
    ...
    for (
      let era = 0;
      era < Technologies.Eras.NextEra - Technologies.Eras.BronzeAge;
      era++
    ) {
      ...
      h.push(
        `<span class="custom-option era${Market.Offer === ID ? ' selected' : ''}" data-value="${ID}">${i18n('Eras.' + (era + Technologies.Eras.BronzeAge))}</span>`,
      );

      for (let i = 0; i < 5; i++) {
        ID += 1;
        h.push(
          `<span class="custom-option${Market.Offer === ID ? ' selected' : ''}" data-value="${ID}">${GoodsList[5 * era + i]['name']}</span>`,
        );
      }
    }
    ...
    h.push(
      '<td><label class="game-cursor"><input class="tradepartnerneighbor game-cursor" ' +
        (Market.TradePartnerNeighbor ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.TradePartnerNeighbor') +
        '</label></td>',
    );
    h.push(
      '<td><label class="game-cursor"><input class="tradeforhigher game-cursor" ' +
        (Market.TradeForHigher ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.TradeForHigher') +
        '</label></td>',
    );
    h.push(
      '<td><label class="game-cursor"><input class="tradeadvantage game-cursor" ' +
        (Market.TradeAdvantage ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.TradeAdvantage') +
        '</label></td>',
    );
    h.push('</tr>');
    ...
    h.push(
      '<td><label class="game-cursor"><input class="tradepartnerguild game-cursor" ' +
        (Market.TradePartnerGuild ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.TradePartnerGuild') +
        '</label></td>',
    );
    h.push(
      '<td><label class="game-cursor"><input class="tradeforequal game-cursor" ' +
        (Market.TradeForEqual ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.TradeForEqual') +
        '</label></td>',
    );
    h.push(
      '<td><label class="game-cursor"><input class="tradefairstock game-cursor" ' +
        (Market.TradeFairStock ? 'checked' : '') +
        ' type="checkbox" title="' +
        HTML.i18nTooltip(i18n('Boxes.Market.TradeFairStockTT')) +
        '">' +
        i18n('Boxes.Market.TradeFairStock') +
        '</label></td>',
    );
    h.push('</tr>');
    ...
    h.push('<tr>');
    h.push(
      '<td><label class="game-cursor" for="minquantity">' +
        i18n('Boxes.Market.MinQuantity') +
        '</label></td>',
    );
    h.push(
      '<td title="' +
        HTML.i18nTooltip(i18n('Boxes.Market.TTMinQuantity')) +
        '"><input type="number" id="minquantity" step="1" min="0" max="1000000" value="' +
        Market.MinQuantity +
        '"></td>',
    );
    h.push(
      '<td><label class="game-cursor"><input class="tradepartnerfriend game-cursor" ' +
        (Market.TradePartnerFriend ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.TradePartnerFriend') +
        '</label></td>',
    );
    h.push(
      '<td><label class="game-cursor"><input class="tradeforlower game-cursor" ' +
        (Market.TradeForLower ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.TradeForLower') +
        '</label></td>',
    );
    h.push(
      '<td><label class="game-cursor"><input class="tradefair game-cursor" ' +
        (Market.TradeFair ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.TradeFair') +
        '</label></td>',
    );
    h.push('</tr>');
    ...
    h.push('<tr>');
    h.push(
      '<td><label class="game-cursor" for="maxresults">' +
        i18n('Boxes.Market.MaxResults') +
        '</label></td>',
    );
    h.push(
      '<td><input type="number" id="maxresults" step="1" min="1" max="1000000" value="' +
        Market.MaxResults +
        '"></td>',
    );
    h.push(
      '<td><label class="game-cursor"><input class="showownoffers game-cursor" ' +
        (Market.ShowOwnOffers ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.ShowOwnOffers') +
        '</label></td>',
    );
    h.push('<td></td>');
    h.push(
      '<td><label class="game-cursor"><input class="tradedisadvantage game-cursor" ' +
        (Market.TradeDisadvantage ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.TradeDisadvantage') +
        '</label></td>',
    );
    h.push('</tr>');
    ...
    h.push('<tr>');
    h.push(
      '<td colspan="2"><label class="game-cursor"><input class="onlyaffordable game-cursor" ' +
        (Market.OnlyAffordable ? 'checked' : '') +
        ' type="checkbox">' +
        i18n('Boxes.Market.OnlyAffordable') +
        '</label></td>',
    );
    h.push('<td></td>');
    h.push('<td></td>');
    ...
    h.push('<tr>');
    h.push(
      '<th data-export2="Offered goods" data-export3="Offered amount" colspan="3">' +
        i18n('Boxes.Market.OfferColumn') +
        '</th>',
    );
    h.push(
      '<th data-export2="Requested goods" data-export3="Requested amount" colspan="3">' +
        i18n('Boxes.Market.NeedColumn') +
        '</th>',
    );
    h.push(
      '<th data-export="Rate">' + i18n('Boxes.Market.RateColumn') + '</th>',
    );
    h.push(
      '<th data-export="Player">' + i18n('Boxes.Market.PlayerColumn') + '</th>',
    );
    ...
    for (let i = 0; i < Market.Trades.length; i++) {
      ...
      if (Market.TestFilter(Trade)) {
        let OfferGoodID = Trade['offer']['good_id'],
          ...
          OfferTT = HTML.i18nReplacer(i18n('Boxes.Market.OfferTT'), {
            era: i18n('Eras.' + OfferEra),
            stock: HTML.Format(ResourceStock[OfferGoodID]),
          }),
          NeedTT = HTML.i18nReplacer(i18n('Boxes.Market.NeedTT'), {
            era: i18n('Eras.' + NeedEra),
            stock: HTML.Format(ResourceStock[NeedGoodID]),
          }),
          CurrentPos = Trade['merchant']['is_self'] ? OwnPos : Pos;

        h.push('<tr>');
        h.push(
          '<td class="goods-image"><span class="goods-sprite sprite-35 ' +
            GoodsData[OfferGoodID]['id'] +
            '"></span></td>',
        );
        h.push(
          '<td><strong class="td-tooltip" title="' +
            HTML.i18nTooltip(OfferTT) +
            '">' +
            GoodsData[OfferGoodID]['name'] +
            '</strong></td>',
        );
        h.push(
          '<td><strong class="td-tooltip" title="' +
        ...
        h.push(
          '<td class="goods-image"><span class="goods-sprite sprite-35 ' +
            GoodsData[NeedGoodID]['id'] +
            '"></span></td>',
        );
        h.push(
          '<td><strong class="td-tooltip" title="' +
            HTML.i18nTooltip(NeedTT) +
            '">' +
            GoodsData[NeedGoodID]['name'] +
            '</strong></td>',
        );
        h.push(
          '<td><strong class="td-tooltip" title="' +
        ...
        h.push(
          '<td class="text-center">' +
            HTML.Format(
              MainParser.round(
                (Trade['offer']['value'] / Trade['need']['value']) * 100,
              ) / 100,
            ) +
            '</td>',
        );
  ...
  TestFilter: (Trade) => {
    ...
    if (
      !(
        Trade['merchant']['is_guild_member'] ||
        Trade['offer']['value'] >= Market.MinQuantity
      )
    ) {
      //ignore MinQuanity for guild members
      return false;
    }

    // only Affordable
    if (
      Market.OnlyAffordable &&
      Trade.need.value > (ResourceStock[Trade.need.good_id] || 0)
    ) {
      return false;
    }
    ...
    if (IsOwnOffer) {
      ...
      if (
        !(
          (Market.TradePartnerNeighbor && Trade['merchant']['is_neighbor']) ||
          (Market.TradePartnerGuild && Trade['merchant']['is_guild_member']) ||
          (Market.TradePartnerFriend && Trade['merchant']['is_friend'])
        )
      ) {
        return false;
      }
    ...
    CurrentTradeAdvantage =
      IsOwnOffer ? Market.TradeDisadvantage : Market.TradeAdvantage;
    ...
    if (Rating === 1) {
      ...
      let CurrentOfferValue =
          IsOwnOffer ? Trade['need']['value'] : Trade['offer']['value'],
        CurrentNeedValue =
          IsOwnOffer ? Trade['offer']['value'] : Trade['need']['value'];

      if (
        ResourceStock[OfferGoodID] + CurrentOfferValue / 2 <
        ResourceStock[NeedGoodID] - CurrentNeedValue / 2
      ) {
        //Stock is higher
    ...
    CurrentTradeDisdvantage =
      IsOwnOffer ? Market.TradeAdvantage : Market.TradeDisadvantage;
  ...
  ShowSettingsButton: () => {
    ...
    let h = [];
    h.push(
      `${i18n('Boxes.General.Export')}: <span class="btn-group"><button class="btn" onclick="HTML.ExportTable($('#MarketBody').find('.foe-table.exportable'), 'csv', 'Market')">CSV</button>`,
    );
    h.push(
      `<button class="btn" onclick="HTML.ExportTable($('#MarketBody').find('.foe-table.exportable'), 'json', 'Market')">JSON</button></span>`,
    );
    h.push(
      `<p><input id="autoStartMarket" name="autoStartMarket" value="1" type="checkbox" ${autoOpen === true ? ' checked="checked"' : ''} /> <label for="autoStartMarket">${i18n('Boxes.Market.Settings.Autostart')}</label></p>`,
    );

    h.push(
      `<p><button onclick="Market.SaveSettings()" id="save-market-settings" class="btn" style="width:100%">${i18n('Boxes.Settings.Save')}</button></p>`,
    );
  ...
  SaveSettings: () => {
    let value = false;
    if ($('#autoStartMarket').is(':checked')) value = true;
