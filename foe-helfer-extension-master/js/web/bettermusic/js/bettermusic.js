...
FoEproxy.addHandler(
  ...
  (data, postData) => {
    ...
    if ($('#betterMusic1').length === 0) {
      ...
      newSound.volume = 0;
      newSound.loop = true;
      newSound.onloadedmetadata = function () {
        betterMusic.setEvent((id = 'betterMusic1'));
      };
      ...
      newSound2.volume = 0;
      newSound2.loop = true;
      newSound2.onloadedmetadata = function () {
        betterMusic.setEvent((id = 'betterMusic2'));
      };
      ...
      newSound3.volume = 0;
      newSound3.loop = true;
      newSound3.onloadedmetadata = function () {
        betterMusic.setEvent((id = 'betterMusic3'));
      };
...
let betterMusic = {
  ...
  PossibleTracks: {
    FoE_CityTrack_Vs2: {
      Volume: 1,
      Name: 'Stone Age - Early Middle Ages',
      Age: 1,
      Agelimit: 4,
    },
    foe_music_hma_to_col_1_vs2: {
      Volume: 1,
      Name: 'High middle Ages - Colonial Age',
      Age: 5,
      Agelimit: 7,
    },
    foe_music_ind_to_pro_1_vs1: {
      Volume: 1,
      Name: 'Industrial Age - Contemporary Era',
      Age: 8,
      Agelimit: 12,
    },
    foe_music_tmr_to_fut: {
      Volume: 1,
      Name: 'Tomorrow Era - Space Age Mars',
      Age: 13,
      Agelimit: 18,
    },
    foe_music_future_2_vs1: {
      Volume: 1,
      Name: 'Future 2',
      Age: 14,
      Agelimit: 14,
    ...
    foe_music_mars: {
      Volume: 1,
      Name: 'Space Age Mars (Colony)',
      Age: 18,
      Agelimit: 18,
      Outpost: true,
    },
    foe_music_asteroid_belt_city: {
      Volume: 1,
      Name: 'Space Age Asteroid Belt - Space Age Venus',
      Age: 19,
      Agelimit: 20,
    },
    foe_music_asteroid_belt: {
      Volume: 1,
      Name: 'Space Age Asteroid Belt (Colony)',
      Age: 19,
      Agelimit: 19,
      Outpost: true,
    },
    foe_music_venus: {
      Volume: 1,
      Name: 'Space Age Venus (Colony)',
      Age: 20,
      Agelimit: 20,
      Outpost: true,
    },
    foe_music_jupiter_moon_city: {
      Volume: 1,
      Name: 'Space Age Jupiter Moon',
      Age: 21,
      Agelimit: 21,
    },
    foe_music_jupiter_moon: {
      Volume: 1,
      Name: 'Space Age Jupiter Moon (Colony)',
      Age: 21,
      Agelimit: 22,
      Outpost: true,
    },
    foe_music_titan: {
      Volume: 1,
      Name: 'Space Age Titan',
      Age: 22,
      Agelimit: 22,
    },
    foe_music_space_hub: {
      Volume: 1,
      Name: 'Space Age Space Hub',
      Age: 23,
      Agelimit: 23,
    },
    foe_music_tavern: { Volume: 0.7, Name: 'Tavern' },
    foe_music_expedition: { Volume: 0.7, Name: 'Guild Expedition' },
    foe_music_battlegrounds: { Volume: 0.7, Name: 'Guild Battlegrounds' },
    foe_music_pvp_arena: { Volume: 0.6, Name: 'PvP Arena' },
    FoE_BattleTheme_Vs1: { Volume: 0.7, Name: 'Battle Theme' },
    foe_music_stpatricks_v2: {
      Volume: 0.6,
      Name: 'St Patricks Day Event',
      Event: 'st_patricks_event',
    },
    age23_background_music: {
      Volume: 0.6,
      Name: 'Anniversary Event',
      Event: 'anniversary_event',
    },
    foe_music_anniversary: {
      Volume: 0.5,
      Name: 'Ages Event',
      Event: 'forge_ages_event',
    },
    foe_music_wildlife: {
      Volume: 0.6,
      Name: 'Wildlife Event',
      Event: 'wildlife_event',
    },
    foe_music_archeology: {
      Volume: 0.6,
      Name: 'Archaeology  Event',
      Event: 'archeology_event',
    },
    foe_music_hero: {
      Volume: 0.6,
      Name: 'Fellowship Event 22',
      Event: 'hero_event',
    },
    cup23_background_music: {
      Volume: 0.6,
      Name: 'Soccer Event',
      Event: 'soccer_event',
    },
    foe_music_fellowship: {
      Volume: 0.6,
      Name: 'Fellowship Event 23',
    ...
    foe_music_care: { Volume: 0.6, Name: 'Care Event', Event: 'care_event' },
    foe_music_summer: {
      Volume: 0.7,
      Name: 'Summer Event',
      Event: 'summer_event',
    },
    foe_music_fall: { Volume: 0.7, Name: 'Fall Event', Event: 'fall_event' },
    foe_music_halloween: {
      Volume: 0.6,
    ...
    foe_music_japanese: {
      Volume: 1,
      Name: 'Japanese Settlement',
      Settlement: 'japanese',
    },
    foe_music_egyptians: {
      Volume: 1,
      Name: 'Egypt Settlement',
      Settlement: 'egyptians',
    },
    foe_music_aztecs: {
      Volume: 1,
      Name: 'Aztec Settlement',
      Settlement: 'aztecs',
    },
    foe_music_mughals: {
      Volume: 1,
      Name: 'Mughal Settlement',
      Settlement: 'mughals',
    },
    foe_music_polynesia: {
      Volume: 1,
      Name: 'Polynesia Settlement',
      Settlement: 'polynesia',
    },
  },
  ...
  switchTrack: (newTrack, transition = betterMusic.Settings.TransitionTime) => {
    ...
    let path = srcLinks.get(
      betterMusic.PossibleTracks[newTrack].Path ||
        '/sounds/shared/theme/' + newTrack + '.ogg',
      true,
    );
            ...
            $SoundN.animate(
              {
                volume:
                  1 *
                  betterMusic.PossibleTracks[newTrack].Volume *
                  betterMusic.Settings.Volume,
              },
              transition,
            );
          })
  ...
  TrackSelector: () => {
    ...
    betterMusic.playRandom(
      betterMusic.Scenes[betterMusic.currentScene].TitleList,
    );
  },
  ...
  setEvent: (id, transition = betterMusic.Settings.TransitionTime) => {
    ...
    if (timeout != 'NaN') {
      clearTimeout(betterMusic.nextEvent);
      betterMusic.nextEvent = setTimeout(function () {
        betterMusic.TrackSelector();
      }, timeout);
    }
  },
  ...
  setScene: (scene) => {
    ...
    if (betterMusic.Scenes[scene].TitleList.includes(betterMusic.currentTitle))
      return;
  ...
  loadSettings: () => {
    tempSettings = JSON.parse(
      localStorage.getItem('betterMusicSettings') || '{}',
    );
    ...
    betterMusic.Settings = betterMusic.update(
      betterMusic.Settings,
      tempSettings,
    );
  },
  ...
  saveSettings: () => {
    localStorage.setItem(
      'betterMusicSettings',
      JSON.stringify(betterMusic.Settings),
    );
    betterMusic.buildlists();
  },
  ...
  setSceneTitle: (e) => {
    ...
    betterMusic.Settings.Scenes[e.target.dataset.scene][
      e.target.dataset.title
    ] = e.target.classList.contains('betterMusicSelected');
  },
  ...
  buildlist: (scene) => {
    ...
    for (title in betterMusic.Settings.Scenes[scene]) {
      ...
      if (
        scene === 'settlement' &&
        betterMusic.PossibleTracks[title].Settlement !=
          Outposts?.OutpostData?.content &&
        betterMusic.PossibleTracks[title].Settlement != undefined &&
        !betterMusic.IgnoreSettlement
      )
        continue;
      if (
        scene === 'colony' &&
        (((betterMusic.PossibleTracks[title].Agelimit < CurrentEraID ||
          betterMusic.PossibleTracks[title].Age > CurrentEraID) &&
          betterMusic.Settings.Colony == 2) ||
          (betterMusic.PossibleTracks[title].Age > CurrentEraID &&
            betterMusic.Settings.Colony == 1))
      )
        continue;
      if (
        scene === 'main' &&
        ((betterMusic.Settings.MainCity == 2 &&
          (betterMusic.PossibleTracks[title].Agelimit < CurrentEraID ||
            betterMusic.PossibleTracks[title].Age > CurrentEraID)) ||
          (betterMusic.Settings.MainCity == 1 &&
            betterMusic.PossibleTracks[title].Age > CurrentEraID))
      )
        continue;
      if (betterMusic.Settings.Scenes[scene][title])
        betterMusic.Scenes[scene].TitleList.push(title);
    }
  },
};
